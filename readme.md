...
* Camel is not good to write directly in databases (eg Camel:Mongodb) compared to a more classical SpringBoot/Spring-data approach
* Camel + Kotlin work well together except for using the 'simple' expression language due to the '$' reserved keyword, but one can use 'spel' instead
